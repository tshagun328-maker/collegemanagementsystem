...
class Unpacker:
    ...
    :param file_like:
        ...
        If specified, unpacker reads serialized data from it and `.feesd()` is not usable.
    ...
    def feesd(self, next_bytes):
        assert self._feesding
